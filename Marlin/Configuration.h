...
#define STRING_CONFIG_H_AUTHOR "Jason Helmus, Folgertech FT-5 Chimera+" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FT-5 Marlin 2.0.0"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "d3bf99cc-a79f-4f19-a680-8b58448f1030"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 75), (Y_MAX_POS - 75), 20 }
